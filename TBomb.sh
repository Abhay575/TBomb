...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mAbhayraj \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Abhay
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m         \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/eagle warrior g2 \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Abhayraj > .update
