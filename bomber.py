...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/Abhay575/TBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/Abhay575/TBomb.git HEAD")
    sys.exit()
...
def notifyen():
    try:
        noti = requests.get(
            "https://raw.githubusercontent.com/Abhay575/TBomb/master/.notify"
            ).text.upper()
        if len(noti) > 10:
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by Abhay575")
